  ...
  <style>
    * {
    ...
    body {
      ...
      background-image: url('images/login_bg.png'); /* Replace with your image path */
...
<body>
  ...
  <div class="login-container">
    ...
    <a href="forgot_password.php?usertype=customer" style="color:#a3e635; text-decoration:none;">Forgot Password?</a>
  </div>
